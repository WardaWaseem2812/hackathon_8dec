    ...
    <div className="w-[1439px] h-[716px] absolute top-[136px] left-[1px] border">
      <div className="w-[1440px] h-[716px]">
        <Image
          ...
          alt="women"
          width={1440} // Set the width
          height={716} // Set the height
        />
      </div>
      
      {/* Content Overlay */}
      <div className="absolute flex flex-col justify-center left-[100px] top-[100px] items-start gap-[35px] px-6 lg:px-16 z-10 pt-24">
